<?php
$css = '<style>
/* Foundation for Emails 2.3.1 */
/* https://get.foundation/emails/docs/ */
/* DO NOT modify this file, all updates should be done within foundation-emails-overrides.css */
...
table.button table td {
    background: #2a43f8;
    background-color: #2a43f8;
    border-color: #2a43f8;
    background-image: linear-gradient(to left, #3196ec 3%, #2a43f8);
    font-size: 19px;
}
