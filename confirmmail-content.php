              ...
              <div class="card shadow-lg">
                  <div class="card-body p-4">
                    ...
                    <form class="mt-4 needs-validation" novalidate action="confirmmail.php" method="post">
                        ...
                        <div class="row">
                          <div class="mb-3 col-md-6">
                            <input type="password" class="form-control" oninput="validatePassword(this.value)" placeholder="Password" name="password1" required autofocus>
                          ...
                          <div class="mb-3 col-md-6">
                            <input type="password" class="form-control" placeholder="Password" id="password2" name="password2" required>
                            <div id="passwordError" class="invalid-feedback">Password does not match</div>
                          </div>
                        </div>

                        <div class="d-grid mt-5">
                          <button class="btn btn-primary btn-lg" type="submit">Proceed to update details</button>
                        </div>
                    </form>
                    ...
                    <!-- <div class="d-flex justify-content-between gap-md-5 mt-4">
                        ...
                        <a href="register.php" class="btn-link text-decoration-none">Create a new account</a>
                    </div> -->
