               ...
               <figure class="m-0">
                  <div class="d-inline-flex align-items-center position-relative pt-xl-3 mb-3">
                     <div class="flex-shrink-0">
                        <img class="hv-oc img-xl rounded-circle border" src="assets/img/<?php echo $user_avatar?'uploads/'.$user_avatar:'profile-photos/3.png' ?>" alt="Profile Picture" loading="lazy">
                     </div>
                     <div class="flex-grow-1 ms-4">
                        <a href="#" class="h1 btn-link text-body-emphasis"><?php echo $user_fullname; ?></a>
         ...
         <div class="content__boxed mt-4">
            <div class="content__wrap">
                  ...
                  <div class="w-md-200px flex-shrink-0">
                     ...
                     <div class="text-primary">
                        ...
                        <ul class="list-unstyled mb-3">
                           ...
                           <li class="mb-2"><i class="demo-psi-internet fs-5 me-3"></i><a href="https://themeon.net/" class="btn-link text-decoration-underline" target="blank">https://themeon.net/</a></li>
                           <li class="mb-2"><i class="demo-psi-old-telephone fs-5 me-3"></i><?php echo $user_mobile ?></li>
                        </ul>
                     </div>
               ...
               <i class=" demo-pli-camera-2 fs-4"></i>
                              ...
                              <button class="btn btn-sm btn-primary hstack gap-2 ms-auto" type="submit">
                     ...
                     <div class="card">
                        <div class="card-body">
                           ...
                           <div class="d-flex mb-4">
                              <div class="flex-shrink-0">
                                 <img class="img-sm rounded-circle" src="../../assets/img/profile-photos/2.png" alt="Profile Picture" loading="lazy">
                              </div>
                              <div class="flex-grow-1 ms-3">
                                 <div class="mb-1">
                                    <a href="#" class="h6 btn-link">John Doe</a> Share a status of <a href="#" class="h6 btn-link">Lucy Doe</a>
                                 </div>
                                 <small class="d-block text-body-secondary mb-2"><i class="demo-pli-smartphone-3 fs-5"></i> - From Mobile - 26 min ago</small>

                                 <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt </p>
                                 <a class="btn btn-xs btn-primary disabled"><i class="demo-psi-like fs-5 me-2"></i>You Liked this post </a>
                                 <a class="btn btn-xs btn-outline-light"><i class="demo-pli-heart-2 fs-5 me-2"></i>Love</a>
                           ...
                           <div class="d-flex mb-4">
                              <div class="flex-shrink-0">
                                 <img class="img-sm rounded-circle" src="../../assets/img/profile-photos/3.png" alt="Profile Picture" loading="lazy">
                              </div>
                              <div class="flex-grow-1 ms-3">
                                 <div class="mb-1">
                                    <a href="#" class="h6 btn-link">Stephen Tran</a> started following <a href="#" class="h6 btn-link">Kathryn Obrien</a>
                                 </div>
                                 <small class="d-block text-body-secondary mb-2"><i class="demo-pli-laptop fs-5"></i> - From Notebook - 34 min ago</small>

                                 <p>Lorem Ipsum decided to leave for the far World of Grammar.</p>
                                 <a class="btn btn-xs btn-outline-light"><i class="demo-pli-like fs-5 me-2"></i>Like</a>
                                 <a class="btn btn-xs btn-outline-light"><i class="demo-pli-heart-2 fs-5 me-2"></i>Love</a>
                           ...
                           <div class="d-flex mb-4">
                              <div class="flex-shrink-0">
                                 <img class="img-sm rounded-circle" src="../../assets/img/profile-photos/10.png" alt="Profile Picture" loading="lazy">
                              </div>
                              <div class="flex-grow-1 ms-3">
                                 <div class="mb-1">
                                    <a href="#" class="h6 btn-link">Lisa D</a> added new photos
                                 </div>
                                 <small class="d-block text-body-secondary mb-2"><i class="demo-pli-laptop fs-5"></i> - From Notebook - 34 min ago</small>
                                 ...
                                 <div class="row g-1">
                                    <div class="col-6">
                                       <img class="img-fluid rounded" src="../../assets/img/sample-img/img-3.jpg" alt="nature image" loading="lazy">
                                    </div>
                                    <div class="col-6">
                                       <div class="row g-1 mb-3">
                                          <div class="col-6">
                                             <img class="img-fluid rounded" src="../../assets/img/sample-img/img-5.jpg" alt="cooking" loading="lazy">
                                          </div>
                                          <div class="col-6">
                                             <img class="img-fluid rounded" src="../../assets/img/sample-img/img-1.jpg" alt="my car" loading="lazy">
                                          </div>
                                          <div class="col-6">
                                             <img class="img-fluid rounded" src="../../assets/img/sample-img/img-2.jpg" alt="coffee" loading="lazy">
                                          </div>
                                          <div class="col-6">
                                             <img class="img-fluid rounded" src="../../assets/img/sample-img/img-4.jpg" alt="town" loading="lazy">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="d-flex gap-4 mb-4">
                                    <a href="#" class="btn btn-icon btn-sm btn-link text-body-emphasis">
                                       <i class="text-body-secondary demo-pli-heart-2 fs-5 me-2"></i>87
                                    </a>
                                    <a href="#" class="btn btn-icon btn-sm btn-link text-body-emphasis">
                                       <i class="text-body-secondary demo-pli-speech-bubble-4 fs-5 me-2"></i>107
                                    </a>
                                    <a href="#" class="btn btn-icon btn-sm btn-link text-body-emphasis">
                                       <i class="text-body-secondary demo-pli-right-4 fs-5 me-2"></i>95
                                    </a>
                                 </div>
                                 ...
                                 <div class="d-flex mb-4">
                                    <div class="flex-shrink-0">
                                       <img class="img-sm rounded-circle" src="../../assets/img/profile-photos/5.png" alt="Profile Picture" loading="lazy">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                       <div class="mb-1">
                                          <a href="#" class="h6 btn-link">Bobby Marz</a>
                                          <small class="ms-2 text-body-secondary">27min ago</small>
                                       </div>
                                 ...
                                 <!-- END : Reply / Comment Content  -->


                                 <!-- Reply / Comment Content -->
                                 <div class="d-flex mb-4">
                                    <div class="flex-shrink-0">
                                       <img class="img-sm rounded-circle" src="../../assets/img/profile-photos/7.png" alt="Profile Picture" loading="lazy">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                       <div class="mb-1">
                                          <a href="#" class="h6 btn-link">Lucy Moon</a>
                                          <small class="ms-2 text-body-secondary">35min ago</small>
                                       </div>

                                       <p>Duis autem vel eum iriure dolor in vulputate ?</p>
                                       <a class="btn btn-xs btn-outline-light"><i class="demo-pli-like fs-5 me-2"></i>Like</a>
                                       <a class="btn btn-xs btn-outline-light">Reply</a>
                           ...
                           <div class="d-flex mb-4">
                              <div class="flex-shrink-0">
                                 <img class="img-sm rounded-circle" src="../../assets/img/profile-photos/8.png" alt="Profile Picture" loading="lazy">
                              </div>
                              <div class="flex-grow-1 ms-3">
                                 <div class="mb-1">
                                    <a href="#" class="h6 btn-link">Kathryn Obrien</a> commented on your post.
                                 </div>
                                 <small class="d-block text-body-secondary mb-2"><i class="demo-pli-smartphone-3 fs-5"></i> - From Mobile - 55 min ago</small>
