         ...
         <footer class="mt-auto">
            <div class="content__boxed">
               <div class="content__wrap py-3 py-md-1 d-flex flex-column flex-md-row align-items-md-center">
                  <div class="text-nowrap mb-4 mb-md-0">Copyright &copy; <?php echo date('Y')=='2024'?'2024':'2024 - '.date('Y'); ?> <a href="#" class="ms-1 btn-link fw-bold">Setegap Venture Petroleum Sdn. Bhd.</a></div>
