   ...
   <div id="root" class="root mn--max tm--expanded-hd">
      ...
      <section id="content" class="content">
         ...
         <div class="content__boxed">
            <div class="content__wrap">
               <div class="card text-center mb-4 col-xl-12 ">
                  ...
                  <div class="card-body">
                     ...
                     <button class="sidebar-toggler btn btn-danger btn-lg mb-3">Toggle Sidebar</button>


                     <div class="py-2">
                        <input type="checkbox" class="btn-check" id="_dm-roundedContentHeader" onchange="disableRoundedHeader()" autocomplete="off">
                        <label class="btn btn-outline-success" for="_dm-roundedContentHeader">Rounded header</label>

                        <input type="checkbox" class="btn-check" id="_dm-overlappingContentHeader" onchange="changeContentHeader()" autocomplete="off">
                        <label class="btn btn-outline-primary" for="_dm-overlappingContentHeader">Overlapping</label>
                     </div>
                     <p class="mb-5">Start putting content on grids or panels, you can also use different combinations of grids.
